...
public class MMOActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mmo_activity);
        ...
        problem.generateAnswers(2, mmoArray.get(mmoArrayCounter), categories );
        ...
        answer.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                if(radio1.getText().equals(mmoArray.get(mmoArrayCounter)))
                {
                    if (radio1.isChecked())
                    {
                        scoreCounter += 10;
                ...
                else if(radio2.getText().equals(mmoArray.get(mmoArrayCounter)))
                {
                    if (radio2.isChecked())
                    {
                        scoreCounter += 10;
                ...
                else if(radio3.getText().equals(mmoArray.get(mmoArrayCounter)))
                {
                    if (radio3.isChecked())
                    {
                        scoreCounter += 10;
                ...
                else if (radio4.getText().equals(mmoArray.get(mmoArrayCounter)))
                {
                    if (radio4.isChecked())
                    {
                        scoreCounter += 10;
                ...
                else if (mmoArrayCounter <= 9)
                {
                    problem.generateAnswers(2, mmoArray.get(mmoArrayCounter), categories);
                    sw.setImageResource(mmoImages.get(mmoArrayCounter));
        ...
        sw.setImageResource(R.drawable.jinx);
