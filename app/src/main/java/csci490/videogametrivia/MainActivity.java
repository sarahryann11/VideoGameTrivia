...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // score.setText(String.valueOf(actionArrayCounter));
        ...
        problem.generateAnswers(0, actionArray.get(actionArrayCounter), categories );
        ...
        answer.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                if(radio1.getText().equals(actionArray.get(actionArrayCounter)))
                {
                    if (radio1.isChecked())
                    {
                        scoreCounter += 10;
                ...
                else if(radio2.getText().equals(actionArray.get(actionArrayCounter)))
                {
                    if (radio2.isChecked())
                    {
                        scoreCounter += 10;
                ...
                else if(radio3.getText().equals(actionArray.get(actionArrayCounter)))
                {
                    if (radio3.isChecked())
                    {
                        scoreCounter += 10;
                ...
                else if (radio4.getText().equals(actionArray.get(actionArrayCounter)))
                {
                    if (radio4.isChecked())
                    {
                        scoreCounter += 10;
                ...
                actionArrayCounter += 1;
                score.setText(String.valueOf(scoreCounter));

                //imageCounter += 1;

                if(actionArrayCounter > 9)
                {
                ...
                else if (actionArrayCounter <= 9)
                {
                    problem.generateAnswers(0, actionArray.get(actionArrayCounter), categories);
                    sw.setImageResource(actionImages.get(actionArrayCounter));
        ...
        sw.setImageResource(R.drawable.aloy);
    ...
    public class Problem {
        ...
        private Problem(String[] answers) {
